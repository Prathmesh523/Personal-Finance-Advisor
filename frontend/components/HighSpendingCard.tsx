// components/HighSpendingCard.tsx
...
import { CategoryIncrease } from '@/types';
import { TrendingUp } from 'lucide-react';

interface HighSpendingCardProps {
  categories: CategoryIncrease[];
}

export function HighSpendingCard({ categories }: HighSpendingCardProps) {
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-600">
            No significant increases this month. Your spending is stable! ✅
          </p>
        </CardContent>
      </Card>
    );
          ...
          >
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-3">
              <p className="text-sm text-gray-700">
                <span className="font-medium">Reason:</span> {cat.reason}
              </p>
            </div>
